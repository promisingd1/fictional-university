...
?>
	<div class="page-banner">
		<div class="page-banner__bg-image" style="background-image: url(<?php echo get_theme_file_uri('assets/images/library-hero.jpg');
		?>);"></div>
	...
	<div class="full-width-split group">
		<div class="full-width-split__one">
			<div class="full-width-split__inner">
				...
				wp_reset_postdata();
				?>
				<p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link( 'events' ); ?>" class="btn
				btn--blue">View All
                        Events</a></p>
			</div>
		</div>
                        ...
                        <div class="event-summary__content">
                            ...
                            <p>
		                        <?php echo wp_trim_words( get_the_content(),
			                        20 )
		                        ?><a href="<?php the_permalink(); ?>" class="nugray">Read more</a>
                            </p>
                        </div>
                    </div>
				<?php
